# I want to import a table from results. However, I might have issues because it contains metadata fields which cause issues when saving back to results, or has column names that are different from the display names.
